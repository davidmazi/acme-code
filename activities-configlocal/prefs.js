...
const ActivitiesConfiguratorSettingsWidget = GObject.registerClass(
  class ActivitiesConfiguratorSettingsWidget extends Gtk.Grid {
    _init(params) {
      ...
      let version =
        "[ v" +
        this._settings.get_string(Keys.EPVERSION) +
        " GS " +
        this._settings.get_string(Keys.GSPVERSION) +
        " ]";
      ...
      this.attach(
        new Gtk.Label({ label: _("Select Icon"), wrap: true, xalign: 0.0 }),
        1,
        0,
        2,
        1
      ...
      this.attach(
        new Gtk.Label({ label: version, wrap: true, xalign: 1.0 }),
        3,
        0,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("Scale Icon"), wrap: true, xalign: 0.0 }),
        1,
        1,
        2,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("Hide Icon"), wrap: true, xalign: 0.0 }),
        1,
        2,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("Icon Padding"), wrap: true, xalign: 0.0 }),
        1,
        3,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("New Text"), wrap: true, xalign: 0.0 }),
        1,
        4,
        1,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("Hide Text"), wrap: true, xalign: 0.0 }),
        1,
        5,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("Text Padding"), wrap: true, xalign: 0.0 }),
        1,
        6,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({
          label: _("Remove Activities Button"),
          wrap: true,
          xalign: 0.0
        }),
        1,
      ...
      this.attach(
        new Gtk.Label({
          label: _("Hide Panel Rounded Corners"),
          wrap: true,
          xalign: 0.0
        }),
        1,
      ...
      this.attach(
        new Gtk.Label({
          label: _("Hide Application Menu Button Icon"),
          wrap: true,
          xalign: 0.0
        }),
        1,
      ...
      this.attach(
        new Gtk.Label({
          label: _("Show Overview If No Applications Are Running"),
          wrap: true,
          xalign: 0.0
        }),
        1,
      ...
      this.attach(
        new Gtk.Label({ label: _("Transparency"), wrap: true, xalign: 0.0 }),
        1,
        23,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("Vertical Length"), wrap: true, xalign: 0.0 }),
        1,
        24,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("Blur Radius"), wrap: true, xalign: 0.0 }),
        1,
        25,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({ label: _("Spread Radius"), wrap: true, xalign: 0.0 }),
        1,
        26,
        5,
        1
      ...
      this.attach(
        new Gtk.Label({
          label: _("Window Maximized Effect"),
          wrap: true,
          xalign: 0.0
        }),
        0,
      ...
      this.attach(
        new Gtk.Label({
          label: _("Move Activities to the Right"),
          wrap: true,
          xalign: 0.0
        }),
        1,
      ...
      this.attach(
        new Gtk.Label({
          label: _("Enable Conflict Detection"),
          wrap: true,
          xalign: 0.0
        }),
        1,
      ...
      this._noIcon = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.NO_ICON)
      });
      ...
      this._hpadIcon.connect(
        "value-changed",
        this._onIconPaddingChanged.bind(this)
      );
      ...
      this._sclIcon.connect(
        "value-changed",
        this._onIconScalingChanged.bind(this)
      );
      ...
      this._noText = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.NO_TEXT)
      });
      ...
      this._hpadText.connect(
        "value-changed",
        this._onTextPaddingChanged.bind(this)
      );
      ...
      this._noActivities = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.REMOVED)
      });
      this._noActivities.connect(
        "notify::active",
        this._setNoActivities.bind(this)
      );
      ...
      this._noHotCorner = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.NO_HOTC)
      });
      this._hotCornerDelay.connect(
        "value-changed",
        this._onHotCornerDelayChanged.bind(this)
      );
      this._noHotCorner.connect(
        "notify::active",
        this._setNoHotCorner.bind(this)
      );
      ...
      this._hideCorners = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.HIDE_RC)
      });
      this._hideCorners.connect(
        "notify::active",
        this._setHideCorners.bind(this)
      );
      ...
      this._hideAppMenuButtonIcon = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.HIDE_APPMBI)
      });
      this._hideAppMenuButtonIcon.connect(
        "notify::active",
        this._setHideAppMenuButtonIcon.bind(this)
      );
      let hideAppMenuButtonIconBox = new Gtk.Box();
      hideAppMenuButtonIconBox.pack_start(
        this._hideAppMenuButtonIcon,
        false,
        false,
        0
      );
      ...
      this._overrideUserOrClassicTheme = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.OVERR_THEME)
      });
      this._overrideUserOrClassicTheme.connect(
        "notify::active",
        this._setOverrideUserOrClassicTheme.bind(this)
      );
      let overrideUserOrClassicTheme = new Gtk.Box();
      overrideUserOrClassicTheme.pack_start(
        this._overrideUserOrClassicTheme,
        false,
        false,
        0
      );
      ...
      let instructions = new Gtk.Label({
        label: _("Override Shell Theme"),
        wrap: true,
        xalign: 0.0
      });
      ...
      this._showOverview = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.SHOW_OVERVIEW)
      });
      this._showOverview.connect(
        "notify::active",
        this._setShowOverview.bind(this)
      );
      ...
      this._panelColor.connect(
        "notify::color",
        this._onPanelColorChanged.bind(this)
      );
      ...
      this._panelTransparency.connect(
        "value-changed",
        this._onPanelTransparencyChanged.bind(this)
      );
      ...
      this._shadowColor.connect(
        "notify::color",
        this._onPanelShadowColorChanged.bind(this)
      );
      ...
      this._shadowTransparency.set_value(
        this._settings.get_int(Keys.SHADOW_TRANS)
      );
      this._shadowTransparency.connect(
        "value-changed",
        this._onShadowTransparencyChanged.bind(this)
      );
      ...
      this._shadowLength.connect(
        "value-changed",
        this._onShadowLengthChanged.bind(this)
      );
      ...
      this._shadowBlur.connect(
        "value-changed",
        this._onShadowBlurChanged.bind(this)
      );
      ...
      this._shadowSpread.connect(
        "value-changed",
        this._onShadowSpreadChanged.bind(this)
      );
      this.attach(this._shadowSpread, 0, 26, 1, 1);

      // Window Maximized Effect
      this._rbNone = new Gtk.RadioButton({ label: _("Panel - No Effect") });
      this._rbOpaque = new Gtk.RadioButton({
        group: this._rbNone,
        label: _("Opaque Background Color")
      });
      this._rbBlack = new Gtk.RadioButton({
        group: this._rbNone,
        label: _("Black Opaque Background")
      });
      ...
      if (rb == 0) this._rbNone.clicked();
      else if (rb == 1) this._rbOpaque.clicked();
      else this._rbBlack.clicked();
      this._rbNone.connect("toggled", rb => {
        if (rb.get_active) this._settings.set_int(Keys.MAX_WIN_EFFECT, 0);
      });
      this._rbOpaque.connect("toggled", rb => {
        if (rb.get_active) this._settings.set_int(Keys.MAX_WIN_EFFECT, 1);
      });
      this._rbBlack.connect("toggled", rb => {
        if (rb.get_active) this._settings.set_int(Keys.MAX_WIN_EFFECT, 2);
      });
      this.attach(rbGroup, 2, 27, 1, 1);
      this._cbTileMaxEffectOff = new Gtk.CheckButton({
        label: _("Tile Maximized Effect Off")
      });
      ...
      // Conflict Detection
      this._conflictDetection = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.CON_DET)
      });
      this._conflictDetection.connect(
        "notify::active",
        this._setConflictDetection.bind(this)
      );
      ...
      // Position Right
      this._positionRight = new Gtk.Switch({
        active: this._settings.get_boolean(Keys.BTN_POSITION)
      });
      this._positionRight.connect(
        "notify::active",
        this._setPositionRight.bind(this)
      );
      ...
      readmeBtn.connect("clicked", function() {
        Readme.displayWindow("readme");
      });
      ...
      let linkBtn = new Gtk.LinkButton({
        uri: "https://nls1729.github.io/activities_config.html",
        label: _("Website"),
        image: imagex
      });
      ...
      this._settings.connect(
        "changed::" + Keys.SHELL_THEME_ID,
        this._setThemeName.bind(this)
      );
    }
    ...
    _onShadowTransparencyChanged() {
      this._settings.set_int(
        Keys.SHADOW_TRANS,
        this._shadowTransparency.get_value()
      );
    }
